...
class FriendRequestSendAdapter(private val context: Context, private val friendRequestPending: List<String>) : RecyclerView.Adapter<FriendRequestSendAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val immatriculationTextView: TextView = itemView.findViewById(R.id.friend_request_send_ima)
        val cancelButton: Button = itemView.findViewById(R.id.friend_request_send_button_cancel)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.single_friend_request_send, parent, false)
